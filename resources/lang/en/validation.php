...
return [
    ...
    */
    ...
    'after_or_equal' => 'O atributo deve ser uma data posterior ou igual à data.',
    ...
    'before' => 'O atributo deve ser uma data anterior à data.',
    'before_or_equal' => 'O atributo deve ser uma data anterior ou igual à data.',
    'between' => [
        'numeric' => 'O atributo deve estar entre mínimo e máximo.',
    ...
    'unique' => 'O atributo já foi escolhido.',
